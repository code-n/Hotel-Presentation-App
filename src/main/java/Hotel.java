...
public class Hotel extends JFrame implements ActionListener
{
    ...
    public Hotel()
    {
        ...
        l47=new JLabel("This software is developed by 'Mr. Kenneth Kensah '  ");
        l46.setFont(mfnt);
        l47.setFont(mfnt);
        ...
        {
            t1.setText("Error in Loading Jdbc driver for MS Access database ");
        }
    }
    ...
    class MyFocusLis implements FocusListener
    {
        ...
        public void focusLost(FocusEvent e)
        {
            ...
            if(e.getSource()==t38)
            {
                try
                {
                    ps=con.prepareStatement("Select * from Booking where RNo=?");
